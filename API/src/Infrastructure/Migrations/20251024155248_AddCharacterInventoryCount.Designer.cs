...
namespace ProjectX.Infrastructure.Migrations
{
    ...
    [Migration("20251024155248_AddCharacterInventoryCount")]
    partial class AddCharacterInventoryCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectX.Domain.Entities.CharacterInventory", b =>
                {
                    b.HasOne("ProjectX.Domain.Entities.Character", "Character")
                        ...
                        .HasForeignKey("ProjectX.Domain.Entities.CharacterInventory", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
