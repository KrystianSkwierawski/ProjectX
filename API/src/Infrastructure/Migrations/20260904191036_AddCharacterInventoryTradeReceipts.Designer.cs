...
namespace ProjectX.Infrastructure.Migrations
{
    ...
    [Migration("20260904191036_AddCharacterInventoryTradeReceipts")]
    partial class AddCharacterInventoryTradeReceipts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectX.Domain.Entities.CharacterInventory", b =>
                {
                    b.HasOne("ProjectX.Domain.Entities.Character", "Character")
                        ...
                        .HasForeignKey("ProjectX.Domain.Entities.CharacterInventory", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectX.Domain.Entities.Character", b =>
                {
                    ...
                    b.Navigation("CharacterTransforms");
                });
