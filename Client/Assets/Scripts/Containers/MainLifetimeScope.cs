...
{
    [SerializeField] public GameObject _playerCanvas;
    [SerializeField] public GameObject _targetCanvas;
    [SerializeField] public GameObject _progressBarCanvas;
    ...
    protected override void Configure(IContainerBuilder builder)
    {
        ...
        builder.Register<IExperienceService, ExperienceService>(Lifetime.Singleton);

        builder.RegisterInstance(_playerCanvas).Keyed("PlayerCanvas");
        builder.RegisterInstance(_targetCanvas).Keyed("TargetCanvas");
        builder.RegisterInstance(_progressBarCanvas).Keyed("ProgressBarCanvas");
