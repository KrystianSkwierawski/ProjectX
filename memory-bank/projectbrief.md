...
- Tiered Arrow, Rune, Feather, and Oil ammo content is represented in inventory, merchant, localization, icon, and crafting data. Equipped ammo stack transfers are implemented; per-attack consumption is not complete.
...
## Source Of Truth
- This memory bank was initialized from repository inspection on 2026-05-07 and reviewed against repository HEAD `518aac4` on 2026-07-10, incorporating the user clarifications recorded on 2026-07-07 and 2026-07-08.
