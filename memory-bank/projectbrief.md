...
- Inventory slots support persisted drag-and-drop positioning: different items swap, matching stacks merge, and empty positions are represented by `None` placeholders.
