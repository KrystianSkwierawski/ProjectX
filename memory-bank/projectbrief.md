...
- Tiered Arrow, Rune, Feather, and Oil ammo content is represented in inventory, merchant, localization, icon, and crafting data. Ammo equip, swap, and unequip paths exist, but same-type stack merging is inconsistent and per-attack consumption is not complete.
