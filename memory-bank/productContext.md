...
- Persists character health, stats, and equipped gear through the character update API.
...
- UI should expose character, gear, inventory, quest, crafting, hover/target, cursor, quick-access, chat, and translation behavior through Unity scenes and prefabs.
